    ...
    <nav class="social-links">
      ...
      <ul>
        <?php if ( !empty($s_facebook)): ?>
          <li class="large ico facebook"><a href="<?php echo $s_facebook; ?>" class="rounded-ico large" target="_blank"></a></li>
        <?php endif; ?>
        <?php if ( !empty($s_twitter)): ?>
          <li class="large ico twitter"><a href="<?php echo $s_twitter; ?>" class="rounded-ico large" target="_blank"></a></li>
        <?php endif; ?>
        <?php if ( !empty($s_gplus)): ?>
          <li class="large ico google-plus"><a href="<?php echo $s_gplus; ?>" class="rounded-ico large" target="_blank"></a></li>
        <?php endif; ?>
        <?php if ( !empty($s_pinterset)): ?>
          <li class="large ico pinterest"><a href="<?php echo $s_pinterset; ?>" class="rounded-ico large" target="_blank"></a></li>
        <?php endif; ?>
        <?php if ( !empty($s_linkedin)): ?>
          <li class="large ico linkedin"><a href="<?php echo $s_linkedin; ?>" class="rounded-ico large" target="_blank"></a></li>
        <?php endif; ?>
      </ul>
    </nav>
    <?php endif; ?>

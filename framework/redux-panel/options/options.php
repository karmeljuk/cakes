...
if (!function_exists('redux_init')) :
	...
	**/
	...
	$args['menu_icon']  = __('dashicons-editor-code', 'redux-framework-demo');
	...
	$sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'default' => array('url' => T_URI.'/img/ico_logo_icon.png')
			),
				array(
				'id'=>'general-logo-width',
				'type' => 'text',
				'url'=> true,
				'title' => __('Site Logo Width Size', 'redux-framework-demo'),
				'compiler' => 'true',
				'subtitle' => __('By default the logo have 60px width size', 'redux-framework-demo'),
				'default' => 67
			),
					array(
				'id'=>'general-logo-height',
				'type' => 'text',
				'url'=> true,
				'title' => __('Site Logo Height Size', 'redux-framework-demo'),
				'compiler' => 'true',
				'subtitle' => __('By default the logo have 52px height size', 'redux-framework-demo'),
				'default' => 81
			),
          array(
        'id'=>'logo-top-title',
        'type' => 'text',
        'title' => __('Logo Top Title', 'redux-framework-demo'),
        'subtitle' => __('Enter text for logo top area.', 'redux-framework-demo'),
        'default' => 'Invisio',
      ),
          array(
        'id'=>'logo-bottom-title',
        'type' => 'text',
        'title' => __('Logo Bottom Title', 'redux-framework-demo'),
        'subtitle' => __('Enter text for logo bottom area.', 'redux-framework-demo'),
        'default' => 'cakes',
      ),
			    array(
				'id'=>'general-favicon',
				'type' => 'media',
				'url'=> true,
				'title' => __('Browser Favicon (16x16)', 'redux-framework-demo'),
				'compiler' => 'true',
				'subtitle' => __('Upload Favicon icon of size 16x16.', 'redux-framework-demo'),
				'default' => array('url' => T_URI.'/img/favicon.png')
			),
          array(
        'id'       => 'blog-style',
        'type'     => 'radio',
        'title'    => __('Blog Style', 'redux-framework-demo'),
        'subtitle' => __('Choose a style for blog', 'redux-framework-demo'),
        'options'  => array(
            '1' => 'Blog Style 1',
            '2' => 'Blog Style 2',
        ),
        'default' => '1'
			...
			array(
				...
				'subtitle' => __('Paste your Google Analytics Code (or other) here.', 'redux-framework-demo'),
				//'desc' => 'Possible modes can be found at <a href="http://ace.c9.io" target="_blank">http://ace.c9.io/</a>.',
	            'default' => ""
			)
		)
	...
	$sections[] = array(
      ...
      array(
        'id'        =>'social-header',
        'type'      => 'switch',
        'title'     => __('Enable on Header', 'redux-framework-demo'),
        'subtitle'  => __('Switch On/Off to (Show or Hide) social icons on Header.', 'redux-framework-demo'),
        "default"   => 1,
      ),
      array(
        'id'        =>'social-footer',
        'type'      => 'switch',
        'title'     => __('Enable on Footer', 'redux-framework-demo'),
        'subtitle'  => __('Switch On/Off to (Show or Hide) social icons on Footer.', 'redux-framework-demo'),
        "default"   => 1,
      ),
			array(
        'id'        => 's_pinterset',
        'type'      => 'text',
        'title'     => __('Pinterset', 'redux-framework-demo'),
        'subtitle'  => __('Enter Pinterset Social Link URL', 'redux-framework-demo'),
      ),array(
        'id'        => 's_twitter',
        'type'      => 'text',
        'title'     => __('Twitter', 'redux-framework-demo'),
        'subtitle'  => __('Enter Twitter Social Link URL', 'redux-framework-demo'),
      ),
      array(
        'id'        => 's_gplus',
        'type'      => 'text',
        'title'     => __('Google Plus', 'redux-framework-demo'),
        'subtitle'  => __('Enter Google Plus Social Link URL', 'redux-framework-demo'),
      ),
      array(
        'id'        => 's_facebook',
        'type'      => 'text',
        'title'     => __('Facebook', 'redux-framework-demo'),
        'subtitle'  => __('Enter Facebook Social Link URL', 'redux-framework-demo'),
      ),
    array(
        'id'        => 's_linkedin',
        'type'      => 'text',
        'title'     => __('linkedin', 'redux-framework-demo'),
        'subtitle'  => __('Enter Linkedin Social Link URL', 'redux-framework-demo'),
      ),
		),
	);
  ...
  $sections[] = array(
    ...
    'fields' => array(
      array(
        ...
        'subtitle'=> __('Switch On/Off to (Show or Hide) post Date Meta.', 'redux-framework-demo'),
        "default"     => 1,
      ),
      array(
        'id'=>'single-sidebar',
        'type' => 'switch',
        'title' => __('Sidebar on Single Posts', 'redux-framework-demo'),
        'subtitle'=> __('Switch On/Off to (Show or Hide) Sidebar on Single Posts.', 'redux-framework-demo'),
        "default"     => 0,
      ),
      array(
        ...
        'subtitle'=> __('Switch On/Off to (Show or Hide) Social Sharing.', 'redux-framework-demo'),
        "default"     => 1,
      ),
    ),
  );
	...
	$sections[] = array(
		...
		'fields' => array(
			array(
				...
				'subtitle'=> __('Switch On/Off to (Show or Hide) Related Products Block.', 'redux-framework-demo'),
				"default" 		=> 1,
			),
      array(
	...
	$sections[] = array(
		...
		'fields' => array(
			array(
				'id'=>'error-name',
				'type' => 'editor',
				'title' => __('Error Name', 'redux-framework-demo'),
				'default' => 'Error 404',
			),
      array(
        'id'=>'error-msg',
        'type' => 'editor',
        'title' => __('Error Message', 'redux-framework-demo'),
	...
	$sections[] = array(
      ...
      array(
        'id'=>'footer-text-top',
        'type' => 'text',
        'title' => __('Top Text', 'redux-framework-demo'),
        'subtitle' => __('Enter text for top area.', 'redux-framework-demo'),
        'default' => 'Call Us Today.:',
      ),			array(
				'id'=>'footer-phone',
				'type' => 'text',
				'title' => __('Phone Number', 'redux-framework-demo'),
				'subtitle' => __('Enter phone number for top area.', 'redux-framework-demo'),
				'default' => '555. 785.8965',
			),
			array(
				'id'=>'footer-text-bottom',
				'type' => 'editor',
				'title' => __('Bottom Content', 'redux-framework-demo'),
				'subtitle' => __('Enter text for bottom area.', 'redux-framework-demo'),
				'default' => '&copy; Invisio Cakes. All rights reserved.',
			),
		),
	);
...
// 	    return $sections;
// 	}
// 	add_filter('redux/options/cakes_opt/sections', 'redux_add_another_section');
...
if ( !function_exists( 'redux_change_framework_args' ) ):
	...
	add_filter('redux/options/cakes_opt/args', 'redux_change_framework_args');
	// replace redux_demo with your opt_name
endif;
/**
...
if ( !function_exists( 'redux_change_option_defaults' ) ):
	...
	add_filter('redux/options/cakes_opt/defaults', 'redux_change_option_defaults');
	// replace redux_demo with your opt_name
endif;

# Cakes Bugs
**Виділені номери** - закінчена робота
...
##### Хз як витягувати продукти, можливо робити категорією
...
##### Перейменував. Як зробити Our team категорію ?
...
##### Так названо, бо вже є Home Page Testimonials
...
##### Для цього потрібно переробляти весртку
...
##### Свариться на відсутність елементів, яких немає у верстці: posts_nav_link() , wp_link_pages, custom-background

#Код:

42. index.php - style="background-image: url(http://lorempixel.com/1920/341/food) що це?
##### Для відображення, якщо картинка на задана
